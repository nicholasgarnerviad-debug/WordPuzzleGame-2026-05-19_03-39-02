...
- All tests stay green — run via run_tests(mode="PlayMode") (PlayMode-registered suite, 383 tests;
...
3. Tests: Window → General → Test Runner → **PlayMode** → Run All (the suite is PlayMode-registered, **383 tests**).
