...
>
> ⚠️ **Note:** the on-screen UI is now the **"Direction B" purple palette** ([§5](#5-visual-identity) / [§15](#15-design-tokens)); the **screenshot thumbnails below are pre-Direction-B** (older palette, and pre-redesign Stats / Settings / Puzzle Library) — all will be recaptured in a later pass.
