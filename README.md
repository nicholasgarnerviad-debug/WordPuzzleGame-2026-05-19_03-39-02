...
- **Run (human):** Window → General → Test Runner → **PlayMode** → Run All. **MCP agents:** `run_tests(mode="PlayMode")` — it works (full suite **371/371** as of Task 46); EditMode returns 0 (see [§17](#17-notes-for-ai-agents-working-in-this-repo)).
